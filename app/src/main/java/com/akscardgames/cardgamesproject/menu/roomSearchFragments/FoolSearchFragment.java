...
public class FoolSearchFragment extends Fragment {
    ...
    public static FragmentFoolSearchBinding binding;
        ...
        if(!binding.privateCheck.isChecked()) {
            ...
            RoomRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        GameChooseActivity.launchFool(RoomName, playerName);
            ...
            RoomRef = database.getReference("FoolRooms/" + RoomName);
            CreatePasswordFragment dialog = new CreatePasswordFragment("Fool");
                    ...
                    public void onItemClick(RoomData roomData) {
                        ...
                        if (count < size) {
                            if (roomData.getAccess().equals("public")) {
                                ...
                                RoomRef = database.getReference("FoolRooms/" + RoomName);
                                PasswordRequestFragment dialog = new PasswordRequestFragment("Fool");
